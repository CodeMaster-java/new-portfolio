...
export const heroMetrics = [
  { label: "Anos criando sistemas", value: "8+" },
...
export const stackCategories: StackCategory[] = [
  {
    ...
    description:
      "Arquiteturas backend resilientes, integrações de sistemas e pipelines de automação.",
    tools: [
      "Node.js",
      "Python",
      "FastAPI",
  ...
  },
  {
    name: "Frontend",
    description:
      "Interfaces expressivas construídas com sistemas de componentes escaláveis.",
    tools: [
      "React",
      "Next.js",
      "TypeScript",
  ...
  },
  {
    name: "Desktop & Mobile",
    description:
      "Experiências coesas além do navegador, com núcleos de lógica compartilhados entre plataformas.",
    tools: [
      "Electron",
      "React Native",
      "Kotlin",
  ...
  },
  {
    ...
    tools: [
      ...
      "UI/UX In-Game",
      "Localization",
      "Steam Workshop tooling",
    ],
  },
  {
    name: "Dados & Ops",
    description:
      "Observabilidade, DevOps enxuto e entrega guiada por qualidade.",
    tools: [
      "PostgreSQL",
      "MySQL",
      "SQLite",
  ...
  },
  {
    name: "Tooling & Media",
    description:
      "Automação de downloads, encoding e pipelines de assets multimídia.",
    tools: ["FFmpeg", "yt-dlp"],
  },
];
